    ...
    >
      ...
      <motion.div
        className="
          ...
          flex flex-col
          /* Mobile: unchanged — bottom-anchored with pb-20 */
          justify-end pb-20
          /* Desktop: moved down from dead-center to a lower anchor point */
          sm:justify-end sm:pb-24 md:pb-20 lg:pb-16
      ...
      >
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <SocialIcon href="https://www.linkedin.com/in/rohith-sri-sharan-jangam-95b58a15a/" icon={<Linkedin />} />
          </div>
        </motion.div>
      </motion.div>
